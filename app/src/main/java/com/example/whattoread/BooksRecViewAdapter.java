...
import static com.example.whattoread.BookActivity.BOOK_ID_KEY;
...
public class BooksRecViewAdapter extends RecyclerView.Adapter<BooksRecViewAdapter.ViewHolder>{
            ...
            if(parentActivity.equals("allBooks")){
                ...
                holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                            ...
                            builder.setMessage("Are you sure you want to delete "+books.get(holder.getAdapterPosition()).getTitle()+" ?");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txtTitle = itemView.findViewById(R.id.bookTitle);
